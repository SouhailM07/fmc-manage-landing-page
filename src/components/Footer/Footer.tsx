...
import youtube_logo from "/square-youtube.svg";
import twitter_logo from "/twitter.svg";
import pinterest_logo from "/pinterest.svg";
import instagram_logo from "/instagram.svg";

export default function Footer() {
  interface socialLinks_type {
    img: string;
    label: string;
  }
  let socialLinks: socialLinks_type[] = [
    { img: facebook_logo, label: "facebook" },
    { img: youtube_logo, label: "youtube" },
    { img: twitter_logo, label: "twitter" },
    { img: pinterest_logo, label: "pinterest" },
    { img: instagram_logo, label: "instagram" },
  ];
  const links1: string[] = ["Home", "Pricing", "Products", "About Us"];
  const links2: string[] = ["Careers", "Community", "Privacy Policy"];
...
let YoutubeLogo = () => {
  return (
    <>
      <svg
        className="h-[2rem] w-[2rem] fill-white hover:fill-BrightRed"
